...
def train(rank, a, h, pretrained=True):
    if h.num_gpus > 1:
        ...
        for i, batch in enumerate(train_loader):
            ...
            if rank == 0:
                ...
                if steps % a.summary_interval == 0:
                    ...
                    sw.add_scalar("mpd/fm_loss_mpd", loss_fm_f.item(), steps)
                    sw.add_scalar("mpd/gen_loss_mpd", loss_gen_f.item(), steps)
                    sw.add_scalar("mpd/disc_loss_mpd", loss_disc_f.item(), steps)

                    sw.add_scalar("msd/fm_loss_mrd", loss_fm_s.item(), steps)
                    sw.add_scalar("msd/gen_loss_mrd", loss_gen_s.item(), steps)
                    sw.add_scalar("msd/disc_loss_mrd", loss_disc_s.item(), steps)
...
def main():
    ...
    parser.add_argument('--input_training_file', default='test_text/annotations_20201223150014_allspeaker_entired_20240419092955_improve.txt')

    parser.add_argument('--input_validation_file', default='LJSpeech-1.1/validation.txt')

    parser.add_argument('--checkpoint_path', default='checkpoints/cp_hifigan_allspeaker_fmax_gt_ft_euniversal_256v1')
    parser.add_argument('--adaptation_path', default='pretrained_model/UNIVERSAL_V1/')
